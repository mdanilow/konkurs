...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net rgb2ycbcr_0_de_out [get_bd_pins KLT_2200_0/rx_de] [get_bd_pins centroid_0/de] [get_bd_pins mux_0/de_in_1] [get_bd_pins rgb2ycbcr_0/de_out] [get_bd_pins wysw_0/de_in]
  connect_bd_net -net rgb2ycbcr_0_h_sync_out [get_bd_pins KLT_2200_0/rx_hsync] [get_bd_pins centroid_0/hsync] [get_bd_pins mux_0/h_sync_1] [get_bd_pins rgb2ycbcr_0/h_sync_out] [get_bd_pins wysw_0/hsync_in]
  connect_bd_net -net rgb2ycbcr_0_v_sync_out [get_bd_pins KLT_2200_0/rx_vsync] [get_bd_pins centroid_0/vsync] [get_bd_pins mux_0/v_sync_1] [get_bd_pins rgb2ycbcr_0/v_sync_out] [get_bd_pins wysw_0/vsync_in]
  connect_bd_net -net rgb2ycbcr_0_y [get_bd_pins KLT_2200_0/pixel_in] [get_bd_pins rgb2ycbcr_0/y]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net xlconstant_3_dout [get_bd_pins KLT_2200_0/enable_tracking] [get_bd_pins xlconstant_3/dout]
  connect_bd_net -net xlconstant_4_dout [get_bd_pins KLT_2200_0/reset_position] [get_bd_pins xlconstant_4/dout]
