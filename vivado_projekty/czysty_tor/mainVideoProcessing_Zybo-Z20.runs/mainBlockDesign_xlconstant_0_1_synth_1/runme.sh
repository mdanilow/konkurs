...
HD_PWD='C:/konkurs/vivado_projekty/czysty_tor/mainVideoProcessing_Zybo-Z20.runs/mainBlockDesign_xlconstant_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mainBlockDesign_xlconstant_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mainBlockDesign_xlconstant_0_1.tcl
