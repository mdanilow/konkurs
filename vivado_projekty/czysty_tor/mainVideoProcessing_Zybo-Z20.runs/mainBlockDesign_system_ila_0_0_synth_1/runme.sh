...
HD_PWD='C:/konkurs/vivado_projekty/czysty_tor/mainVideoProcessing_Zybo-Z20.runs/mainBlockDesign_system_ila_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mainBlockDesign_system_ila_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mainBlockDesign_system_ila_0_0.tcl
