...
proc create_root_design { parentCell } {
  ...
  # Create instance: KLT_0, and set properties
  set KLT_0 [ create_bd_cell -type ip -vlnv nsn-intra.net:user:KLT:1.0 KLT_0 ]
  ...
  connect_bd_net -net KLT_0_pixel_out [get_bd_pins KLT_0/pixel_out] [get_bd_pins rgb2dvi_0/vid_pData]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins dvi2rgb_0/RefClk]
  connect_bd_net -net dvi2rgb_0_PixelClk [get_bd_pins KLT_0/rx_pclk] [get_bd_pins dvi2rgb_0/PixelClk] [get_bd_pins rgb2dvi_0/PixelClk] [get_bd_pins rgb2ycbcr_0/clk]
  ...
  connect_bd_net -net rgb2ycbcr_0_de_out [get_bd_pins KLT_0/rx_de] [get_bd_pins rgb2dvi_0/vid_pVDE] [get_bd_pins rgb2ycbcr_0/de_out]
  connect_bd_net -net rgb2ycbcr_0_h_sync_out [get_bd_pins KLT_0/rx_hsync] [get_bd_pins rgb2dvi_0/vid_pHSync] [get_bd_pins rgb2ycbcr_0/h_sync_out]
  connect_bd_net -net rgb2ycbcr_0_v_sync_out [get_bd_pins KLT_0/rx_vsync] [get_bd_pins rgb2dvi_0/vid_pVSync] [get_bd_pins rgb2ycbcr_0/v_sync_out]
  connect_bd_net -net rgb2ycbcr_0_y [get_bd_pins KLT_0/pixel_in] [get_bd_pins rgb2ycbcr_0/y]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net xlconstant_0_dout [get_bd_ports hdmi_rx_hpd] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins KLT_0/enable_tracking] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins KLT_0/reset_position] [get_bd_pins xlconstant_2/dout]
