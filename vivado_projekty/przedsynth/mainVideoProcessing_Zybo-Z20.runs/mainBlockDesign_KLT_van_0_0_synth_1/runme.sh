...
HD_PWD='C:/konkurs/vivado_projekty/przedsynth/mainVideoProcessing_Zybo-Z20.runs/mainBlockDesign_KLT_van_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mainBlockDesign_KLT_van_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mainBlockDesign_KLT_van_0_0.tcl
