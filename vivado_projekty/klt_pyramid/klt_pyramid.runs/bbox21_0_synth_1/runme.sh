...
HD_PWD='C:/konkurs/vivado_projekty/klt_pyramid/klt_pyramid.runs/bbox21_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bbox21_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bbox21_0.tcl
