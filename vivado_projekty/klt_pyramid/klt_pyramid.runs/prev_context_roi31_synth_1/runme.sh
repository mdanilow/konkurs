...
HD_PWD='C:/konkurs/vivado_projekty/klt_pyramid/klt_pyramid.runs/prev_context_roi31_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log prev_context_roi31.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source prev_context_roi31.tcl
