...
HD_PWD='C:/konkurs/vivado_projekty/klt_pyramid/klt_pyramid.runs/klt_tracker_w10b2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log klt_tracker_w10b2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source klt_tracker_w10b2_0.tcl
