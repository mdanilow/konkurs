...
HD_PWD='C:/konkurs/vivado_projekty/klt_pyramid/klt_pyramid.runs/sub_52m52_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sub_52m52.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sub_52m52.tcl
