...
HD_PWD='C:/konkurs/vivado_projekty/klt_pyramid/klt_pyramid.runs/frame_delay_sim_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log frame_delay_sim.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source frame_delay_sim.tcl
