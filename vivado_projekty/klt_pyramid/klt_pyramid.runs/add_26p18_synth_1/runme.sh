...
HD_PWD='C:/konkurs/vivado_projekty/klt_pyramid/klt_pyramid.runs/add_26p18_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_26p18.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_26p18.tcl
