...
HD_PWD='C:/konkurs/vivado_projekty/klt_pyramid/klt_pyramid.runs/mult_dy_times_window_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_dy_times_window.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_dy_times_window.tcl
