...
HD_PWD='C:/konkurs/vivado_projekty/klt_pyramid/klt_pyramid.runs/KLT_bsyncpar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log KLT_bsyncpar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source KLT_bsyncpar_0.tcl
