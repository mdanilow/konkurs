...
HD_PWD='C:/konkurs/vivado_projekty/klt_pyramid/klt_pyramid.runs/adder_10p10e10_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_10p10e10.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_10p10e10.tcl
