...
HD_PWD='C:/konkurs/vivado_projekty/klt_pyramid/klt_pyramid.runs/mult_26t26_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_26t26.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_26t26.tcl
