...
HD_PWD='C:/konkurs/vivado_projekty/klt_pyramid/klt_pyramid.runs/hsize_counter_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hsize_counter_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hsize_counter_0.tcl
