...
HD_PWD='C:/konkurs/vivado_projekty/klt_pyramid/klt_pyramid.runs/accumulator_adder_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log accumulator_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source accumulator_adder.tcl
