...
HD_PWD='C:/konkurs/vivado_projekty/klt_pyramid/klt_pyramid.runs/sub_8m8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sub_8m8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sub_8m8.tcl
