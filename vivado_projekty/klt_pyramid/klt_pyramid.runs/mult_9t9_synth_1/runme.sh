...
HD_PWD='C:/konkurs/vivado_projekty/klt_pyramid/klt_pyramid.runs/mult_9t9_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_9t9.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_9t9.tcl
