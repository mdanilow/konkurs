...
HD_PWD='C:/konkurs/vivado_projekty/klt_pyramid/klt_pyramid.runs/stream_halter_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stream_halter_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stream_halter_fifo.tcl
