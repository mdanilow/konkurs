...
#
# Generated by Vivado on Fri Dec 28 17:32:08 +0100 2018
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_9 -L xbip_pipe_v3_0_5 -L xbip_bram18k_v3_0_5 -L mult_gen_v12_0_14 -L xil_defaultlib -L secureip -L xpm --snapshot mult_26t26 xil_defaultlib.mult_26t26 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mult_26t26 -key {Behavioral:sim_1:Functional:mult_26t26} -tclbatch cmd.tcl -log simulate.log
}
