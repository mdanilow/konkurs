...
#
# Generated by export_simulation on Tue May 07 12:20:00 +0200 2019
#
################################################################################
...
'-reset_run' switch to the './hsize_counter_0.sh' script.

./hsize_counter_0.sh -reset_run
...
./hsize_counter_0.sh -noclean_files

For more information on the script, please type './hsize_counter_0.sh -help'.
