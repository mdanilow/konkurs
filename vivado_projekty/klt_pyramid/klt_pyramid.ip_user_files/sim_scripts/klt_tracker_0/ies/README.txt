...
#
# Generated by export_simulation on Wed Apr 17 23:26:03 +0200 2019
#
################################################################################
...
'-reset_run' switch to the './klt_tracker_0.sh' script.

./klt_tracker_0.sh -reset_run
...
./klt_tracker_0.sh -noclean_files

For more information on the script, please type './klt_tracker_0.sh -help'.
