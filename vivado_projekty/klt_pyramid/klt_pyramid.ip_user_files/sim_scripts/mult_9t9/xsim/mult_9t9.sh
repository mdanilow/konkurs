...
#
# Generated by Vivado on Sun Dec 16 18:36:26 +0100 2018
...
# Script info
echo -e "mult_9t9.sh - Script generated by export_simulation (Vivado v2018.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xbip_utils_v3_0_9 -L xbip_pipe_v3_0_5 -L xbip_bram18k_v3_0_5 -L mult_gen_v12_0_14 -L xil_defaultlib -L secureip -L xpm --snapshot mult_9t9 xil_defaultlib.mult_9t9 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mult_9t9 -key {Behavioral:sim_1:Functional:mult_9t9} -tclbatch cmd.tcl -log simulate.log
}
