...
#
# Generated by export_simulation on Sun Dec 16 17:50:36 +0100 2018
#
################################################################################
...
'-reset_run' switch to the './add_26p18.sh' script.

./add_26p18.sh -reset_run
...
./add_26p18.sh -noclean_files

For more information on the script, please type './add_26p18.sh -help'.
