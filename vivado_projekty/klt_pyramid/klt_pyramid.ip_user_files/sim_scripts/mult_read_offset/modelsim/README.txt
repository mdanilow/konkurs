...
#
# Generated by export_simulation on Thu Apr 18 12:05:12 +0200 2019
#
################################################################################
...
'-reset_run' switch to the './mult_read_offset.sh' script.

./mult_read_offset.sh -reset_run
...
./mult_read_offset.sh -noclean_files

For more information on the script, please type './mult_read_offset.sh -help'.
