...
#
# Generated by export_simulation on Tue Apr 30 22:01:33 +0200 2019
#
################################################################################
...
'-reset_run' switch to the './KLT_bsyncpar_0.sh' script.

./KLT_bsyncpar_0.sh -reset_run
...
./KLT_bsyncpar_0.sh -noclean_files

For more information on the script, please type './KLT_bsyncpar_0.sh -help'.
