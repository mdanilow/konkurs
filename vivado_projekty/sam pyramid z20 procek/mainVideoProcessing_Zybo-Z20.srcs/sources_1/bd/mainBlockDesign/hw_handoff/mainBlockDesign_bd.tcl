...
proc create_root_design { parentCell } {
  ...
  # Create instance: deconcat_0, and set properties
  set deconcat_0 [ create_bd_cell -type ip -vlnv nsn-intra.net:user:deconcat:1.0 deconcat_0 ]
