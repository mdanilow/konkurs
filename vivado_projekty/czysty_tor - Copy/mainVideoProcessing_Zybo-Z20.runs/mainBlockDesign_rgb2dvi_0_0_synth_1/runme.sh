...
HD_PWD='/home/vision/Documents/Vivado/2018.2_Projects/mainVideoProcessing_Zybo-Z20/mainVideoProcessing_Zybo-Z20.runs/mainBlockDesign_rgb2dvi_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mainBlockDesign_rgb2dvi_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mainBlockDesign_rgb2dvi_0_0.tcl
