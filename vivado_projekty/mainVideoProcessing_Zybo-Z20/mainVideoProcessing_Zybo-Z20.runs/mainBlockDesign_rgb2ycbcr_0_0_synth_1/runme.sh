...
HD_PWD='C:/konkurs/vivado_projekty/mainVideoProcessing_Zybo-Z20/mainVideoProcessing_Zybo-Z20.runs/mainBlockDesign_rgb2ycbcr_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mainBlockDesign_rgb2ycbcr_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mainBlockDesign_rgb2ycbcr_0_0.tcl
