...
HD_PWD='C:/konkurs/vivado_projekty/mainVideoProcessing_Zybo-Z20/mainVideoProcessing_Zybo-Z20.runs/klt_tracker_w10b2_mult_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log klt_tracker_w10b2_mult_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source klt_tracker_w10b2_mult_0.tcl
